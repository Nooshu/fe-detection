...
@test "3.13.0" {
  run $script_path "$(url_for 3.13.0)"
  [ "$status" -eq 0 ]
  matches_versions 3.11.0 3.12.0 3.13.0
}

@test "4.0.0" {
  run $script_path "$(url_for 4.0.0)"
  [ "$status" -eq 0 ]
  matches_versions 3.12.0 3.13.0 4.0.0
}

@test "4.0.1" {
  run $script_path "$(url_for 4.0.1)"
  [ "$status" -eq 0 ]
  matches_versions 3.13.0 4.0.0 4.0.1
}

@test "4.1.0" {
  run $script_path "$(url_for 4.1.0)"
  [ "$status" -eq 0 ]
  matches_versions 3.13.0 4.0.0 4.1.0
}

@test "4.2.0" {
  run $script_path "$(url_for 4.2.0)"
  [ "$status" -eq 0 ]
